...
Shipped profile resolution:
  ...
  ``birdnest_ai/species/profiles/``. They're installed as
...
from birdnest_ai.species._schema import SpeciesProfile
...
def builtin_profile_path(slug: str) -> Path:
    ...
    try:
        ref = _res.files("birdnest_ai.species.profiles") / filename
    except ModuleNotFoundError as e:
        raise FileNotFoundError(
            f"birdnest_ai.species.profiles package not found "
