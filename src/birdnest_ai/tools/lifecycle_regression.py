...
Usage:
  ...
  python -m birdnest_ai.tools.lifecycle_regression --verbose
  python -m birdnest_ai.tools.lifecycle_regression --image <path>
  python -m birdnest_ai.tools.lifecycle_regression --dir <path>
"""
